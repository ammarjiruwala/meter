...
| **Ratio-based breaker detection** | ARCHITECTURE.md §6 and CONTEXT.md §5C specify different detectors. Phase 1 ships the flat threshold from CONTEXT.md | See PROPOSALS.md A1 |
